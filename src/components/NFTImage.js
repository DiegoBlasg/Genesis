...
export default function NFTImage({ contract, account, token, breed, changeBreed, selercted }) {
                            ...
                            <div className="card bg-zinc-900 w-72 rounded-xl m-4 p-6 space-y-4">
                                {
                                    sowInfo ?
                                        <div style={{ height: "282px" }} className="flex flex-col justify-center align-middle">
                                            <h1 className='text-center text-3xl text-cyan-300 m-4'>{infoToken.color}</h1>
                                            <h1 className='text-center text-3xl text-cyan-300 m-4'>{infoToken.purity}</h1>
                                        </div>
                                        :
                                        <img className="w-full rounded-md transition hover:bg-cyan-300"
                                            src={nftdata.img}
