...
export default function Menu() {
    ...
    return (
        <div>
            <div className="w-full sm:w-auto sm:h-screen flex fixed">
                <div className="w-full flex sm:flex-col justify-between bg-zinc-900 px-2 text-gray-700 shadow sm:h-full">

                    <a href="/">
                        <img className="w-14 mx-auto" src="/logo.png" alt="logo" />
                    </a>
                    <div className='sm:hidden flex justify-center items-center text-zinc-100 cursor-pointer' onClick={() => setSowPhoneMenu(!sowPhoneMenu)}>
                    ...
                    <ul className='hidden sm:block'>
                        ...
                        <li className="hover:bg-zinc-800">
                            <Link to="craft" className="text-zinc-100 h-16 px-6 flex justify-center items-center w-fullfocus:text-orange-500">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-tools" viewBox="0 0 16 16">
                        ...
                        <li className="hover:bg-zinc-800">
                            <Link to="/challenges" className="text-zinc-100 h-16 px-6 flex justify-center items-center w-fullfocus:text-orange-500">
                    ...
                    <a className="h-16 px-6 flex justify-center items-center hover:bg-zinc-800 hover:text-white focus:outline-none" href='#'>
            ...
            {
                sowPhoneMenu &&
                <ul className='bg-zinc-900 fixed w-full mt-16'>
                    <li className="hover:bg-zinc-800">
                    ...
                    <li className="hover:bg-zinc-800">
                        <Link to="/breeding" onClick={() => setSowPhoneMenu(!sowPhoneMenu)} className="text-zinc-100 h-16 px-6 flex justify-center items-center w-full">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-heart-half" viewBox="0 0 16 16">
                                <path d="M8 2.748v11.047c3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01L8 2.748zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143c.06.055.119.112.176.171a3.12 3.12 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15z" />
                            </svg>
                        </Link>
                    ...
                    <li className="hover:bg-zinc-800">
                        <Link to="/craft" onClick={() => setSowPhoneMenu(!sowPhoneMenu)} className="text-zinc-100 h-16 px-6 flex justify-center items-center w-full">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-tools" viewBox="0 0 16 16">
                                <path d="M1 0 0 1l2.2 3.081a1 1 0 0 0 .815.419h.07a1 1 0 0 1 .708.293l2.675 2.675-2.617 2.654A3.003 3.003 0 0 0 0 13a3 3 0 1 0 5.878-.851l2.654-2.617.968.968-.305.914a1 1 0 0 0 .242 1.023l3.27 3.27a.997.997 0 0 0 1.414 0l1.586-1.586a.997.997 0 0 0 0-1.414l-3.27-3.27a1 1 0 0 0-1.023-.242L10.5 9.5l-.96-.96 2.68-2.643A3.005 3.005 0 0 0 16 3c0-.269-.035-.53-.102-.777l-2.14 2.141L12 4l-.364-1.757L13.777.102a3 3 0 0 0-3.675 3.68L7.462 6.46 4.793 3.793a1 1 0 0 1-.293-.707v-.071a1 1 0 0 0-.419-.814L1 0Zm9.646 10.646a.5.5 0 0 1 .708 0l2.914 2.915a.5.5 0 0 1-.707.707l-2.915-2.914a.5.5 0 0 1 0-.708ZM3 11l.471.242.529.026.287.445.445.287.026.529L5 13l-.242.471-.026.529-.445.287-.287.445-.529.026L3 15l-.471-.242L2 14.732l-.287-.445L1.268 14l-.026-.529L1 13l.242-.471.026-.529.445-.287.287-.445.529-.026L3 11Z" />
                            </svg>
                        </Link>
                    ...
                    <li className="hover:bg-zinc-800">
                        <Link to="/challenges" onClick={() => setSowPhoneMenu(!sowPhoneMenu)} className="text-zinc-100 h-16 px-6 flex justify-center items-center w-full">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-list-check" viewBox="0 0 16 16">
                                <path fillRule="evenodd" d="M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zM3.854 2.146a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 1 1 .708-.708L2 3.293l1.146-1.147a.5.5 0 0 1 .708 0zm0 4a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 1 1 .708-.708L2 7.293l1.146-1.147a.5.5 0 0 1 .708 0zm0 4a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 0 1 .708-.708l.146.147 1.146-1.147a.5.5 0 0 1 .708 0z" />
                            </svg>
                        </Link>
